...
.controller('DownloadCtrl', function($httpParamSerializer, $window,
  Countries, DataFilters, DropdownValues, DOWNLOAD_URL) {
  var _this = this;
  ...
  _this.download = function() {
    if (_this.canSubmit()) {
      $window.location = DOWNLOAD_URL + $httpParamSerializer(_this.submitData);
    }
  }
