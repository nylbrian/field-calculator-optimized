...
.directive('prePlantingHousehold',
  function(Common, DropdownValues, TreatmentNames, HOUSEHOLD_DIRECTIVE_URL) {
  return {
    restrict: 'E',
    scope: {
      data: '=',
    ...
    templateUrl: HOUSEHOLD_DIRECTIVE_URL + 'pre-planting.html',
    link: function(scope) {
