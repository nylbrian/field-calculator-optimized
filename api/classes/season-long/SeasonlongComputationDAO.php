...
class SeasonLongComputationDAO {
  const TABLE_NAME = 'season_long_computations';
  private $farmerId;
  ...
  public function getSeedCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_sowing_transplanting sls ON sls.season_long_id = sl.id
  ...
  public function getSowingTransplantingCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        LEFT JOIN season_long_sowing_transplanting sst ON sst.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
  ...
  public function getNurseryPreparationMachineTransplantingCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        LEFT JOIN season_long_sowing_transplanting sls ON sls.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
  ...
  public function getIrrigationCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_irrigation si ON si.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
  ...
  public function getFertilizerApplicationCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_fertilizer_application sf ON sf.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
  ...
  public function getWeedingCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_weeding_herbicide swh ON swh.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
  ...
  public function getLandPreparationDate() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_land_preparation slp ON slp.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array($this->farmerId, $this->farmerSeasonId));
  ...
  public function getNurseryEstablishmentDate() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_sowing_transplanting slst ON slst.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array($this->farmerId, $this->farmerSeasonId));
  ...
  public function getHarvestingDate() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_harvesting_threshing slht ON slht.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array($this->farmerId, $this->farmerSeasonId));
  ...
  public function getPesticideCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_pesticide_application sls ON sls.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
  ...
  public function getHarvestingThreshingCost() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_harvesting_threshing sls ON sls.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_pre_planting_information slp ON slp.season_long_id = sl.id
        INNER JOIN season_long sl2 ON sl2.farmers_id = f.id AND
          sl2.farmer_seasons_id = fs.id
        INNER JOIN season_long_cleaning_drying sls ON sls.season_long_id = sl2.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['exchange_rate'],
        $this->farmerId,
  ...
  public function getStrawYieldPreviousCrop() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        LEFT JOIN season_long_pre_planting_information slp ON slp.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $temp['rice_area'],
        $this->farmerId,
  ...
  public function getGrainYield() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_grain_and_straw_yield slg ON slg.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $temp['rice_area'],
        $this->farmerId,
        $this->farmerSeasonId,
  ...
  public function getTotalNumberOfMaleLabor() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        LEFT JOIN season_long_land_preparation sllp ON sllp.season_long_id = sl.id
        LEFT JOIN season_long_sowing_transplanting sls ON sls.season_long_id = sl.id
        LEFT JOIN season_long_fertilizer_application slf ON slf.season_long_id = sl.id
        LEFT JOIN season_long_weeding_herbicide slw ON slw.season_long_id = sl.id
        LEFT JOIN season_long_pesticide_application slpa ON slpa.season_long_id = sl.id
        LEFT JOIN season_long_harvesting_threshing slht ON slht.season_long_id = sl.id
        LEFT JOIN season_long_cleaning_drying slc ON slc.season_long_id = sl.id
        LEFT JOIN season_long_irrigation sli ON sli.season_long_id = sl.id
  ...
  public function getNitrogenAmount() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_fertilizer_application slf ON slf.season_long_id = sl.id
        INNER JOIN season_long_fertilizer_application_info slfa ON slfa.season_long_fertilizer_application_id = slf.id
      WHERE f.id = %f AND fs.id = %f', array($temp['rice_area'], $this->farmerId, $this->farmerSeasonId));
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_irrigation si ON si.season_long_id = sl.id
        INNER JOIN season_long_irrigation_period sip ON sip.season_long_irrigation_id = si.id
      WHERE f.id = %f AND fs.id = %f', array(
        $this->farmerId,
        $this->farmerSeasonId,
      ));
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_pre_planting_information slp ON slp.season_long_id = sl.id
        INNER JOIN season_long_pre_planting_information_organic_materials slpom
          ON slpom.season_long_pre_planting_information_id = slp.id
      WHERE f.id = %f AND fs.id = %f', array(
        $this->farmerId,
        $this->farmerSeasonId,
      ));
  ...
  protected function getIrrigationMethodGrainYield() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_grain_and_straw_yield slp ON slp.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $this->farmerId,
        $this->farmerSeasonId,
      ));
  ...
  public function getTotalNumberHerbicideApplication() {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_weeding_herbicide slh ON slh.season_long_id = sl.id
        INNER JOIN season_long_weeding_herbicide_application slha
          ON slha.season_long_weeding_herbicide_id = slh.id
      WHERE f.id = %f AND fs.id = %f', array(
        $this->farmerId,
        $this->farmerSeasonId,
      ));
  ...
  public function getTotalNumberApplication($brand) {
    ...
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_pesticide_application slpa ON slpa.season_long_id = sl.id
        INNER JOIN season_long_pesticide_rice_problems_detail slprp
          ON slprp.season_long_pesticide_application_id = slpa.id
  ...
  public function getFoodSafetyScore() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_food_safety slfs ON slfs.season_long_id = sl.id
  ...
  public function getWorkerHealthAndSafetyScore() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_workers_health_safety slwhs ON slwhs.season_long_id = sl.id
      WHERE f.id = %d AND fs.id = %d', array(
        $this->farmerId,
        $this->farmerSeasonId
      ));
  ...
  public function getChildLaborScore() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_child_labor slwhs ON slwhs.season_long_id = sl.id
      WHERE f.id = %d AND fs.id = %d', array(
        $this->farmerId,
        $this->farmerSeasonId
      ));
    ...
    if ($data['child_labor_score'] > 0) {
      ...
      $res = DB::querySlave('
        SELECT id
        FROM season_long_child_labor_record
        WHERE season_long_child_labor_id = %d', array(
        $data['id']
      ));
  ...
  public function getWomenEmpowermentScore() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_women_empowerment slwhs ON slwhs.season_long_id = sl.id
      WHERE f.id = %d AND fs.id = %d', array(
        $this->farmerId,
        $this->farmerSeasonId
      ));
  ...
  public function getPesticideUseEfficiencyScore() {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_pesticide_use_efficiency pue ON pue.season_long_id = sl.id
      WHERE f.id = %d AND fs.id = %d', array(
        $this->farmerId,
        $this->farmerSeasonId
      ));
