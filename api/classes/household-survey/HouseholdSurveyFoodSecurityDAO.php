...
class HouseholdSurveyFoodSecurityDAO {
  const MAIN_TABLE = 'household_survey_food_security';
  ...
  public function insert($data, $seasonLongId) {
    ...
    $sql = 'INSERT INTO `' . self::MAIN_TABLE . '`
      (`household_survey_id`, `rice_amount_wet_season`,
  ...
  public function update($id, $data, $seasonLongId) {
    ...
    DB::queryMaster('UPDATE `' . self::MAIN_TABLE . '`
      SET `household_survey_id` = %d, `rice_amount_wet_season` = %d,
