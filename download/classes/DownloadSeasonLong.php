...
class DownloadSeasonLong {
  const COMPUTATIONS_TABLE_NAME = 'season_long_computations';
  ...
  protected function downloadFile() {
    ...
    header('Content-Disposition: attachment; filename="Season Long.xls"');
  ...
  protected function getContent() {
    $sql = '
      ...
      FROM farmers f
        ...
        INNER JOIN season_long_computations slc ON f.id = slc.farmers_id
          AND fs.id = slc.farmer_seasons_id
        INNER JOIN season_long_general_information sglc on sglc.season_long_id = sl.id
      WHERE true = true';
  ...
  protected function getProblems($id) {
    $result = DB::queryMaster('
      SELECT problem from season_long_general_information_problems
  ...
  protected function getCleaningDrying($farmerId, $farmerSeasonId) {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_cleaning_drying gy ON gy.season_long_id = sl.id
  ...
  protected function getGrainYield($farmerId, $farmerSeasonId) {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_grain_and_straw_yield gy ON gy.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $farmerId,
        $farmerSeasonId,
      ));
  ...
  protected function getHarvestingThreshing($farmerId, $farmerSeasonId) {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_harvesting_threshing ht ON ht.season_long_id = sl.id
      WHERE f.id = %f AND fs.id = %f', array(
        $farmerId,
        $farmerSeasonId,
      ));
  ...
  protected function getWeedControl($farmerId, $farmerSeasonId, $condition) {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_weeding_herbicide wh ON wh.season_long_id = sl.id
  ...
  protected function getFertilizerApplication($farmerId, $farmerSeasonId, $condition) {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_fertilizer_application fa ON fa.season_long_id = sl.id
  ...
  protected function getLandPreparationSowingTransplanting($farmerId, $farmerSeasonId) {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long_sowing_transplanting st ON st.season_long_id = sl.id
  ...
  protected function getPrePlantingInformation($farmerId, $farmerSeasonId) {
    $result = DB::queryMaster('
      ...
      FROM farmers f
        ...
        INNER JOIN season_long sl ON sl.farmers_id = f.id AND
          sl.farmer_seasons_id = fs.id
        INNER JOIN season_long_pre_planting_information pp ON pp.season_long_id = sl.id
    ...
    $result = DB::queryMaster('
      SELECT *
      FROM season_long_pre_planting_information_organic_materials
