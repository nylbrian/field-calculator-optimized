...
class ImportSeasonLong {
  ...
  protected function insertSeasonLong($data) {
    $result = DB::queryMaster('
      INSERT INTO season_long(farmers_id, farmer_seasons_id, import)
      VALUES(%d, %d, 1)', array(
        $data['farmers_id'],
  ...
  protected function insertPrePlantingInformation($data) {
    $result = DB::queryMaster('
      INSERT INTO season_long_pre_planting_information(
        season_long_id, treatment_name, treatment_name_other, import, parcel_has_treatment)
  ...
  protected function insertLandPreparation($data) {
    $result = DB::queryMaster('
      INSERT INTO season_long_land_preparation(season_long_id, crop_establishment, import)
      VALUES(%d, %d, 1)', array(
        $data['season_long_id'],
  ...
  protected function insertFarmerComputations($data) {
    $result = DB::queryMaster('
      INSERT INTO season_long_computations(
  ...
  public function clearImport() {
    ...
    DB::queryMaster('DELETE FROM season_long_computations WHERE import = 1 AND farmers_id > 0');
    DB::queryMaster('DELETE FROM season_long_land_preparation  WHERE import = 1 AND id > 0');
    DB::queryMaster('DELETE FROM season_long_pre_planting_information  WHERE import = 1 AND id > 0');
    DB::queryMaster('DELETE FROM season_long  WHERE import = 1 AND id > 0');
